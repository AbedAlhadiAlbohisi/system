                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control usertype" style="width: 100%;" id="guard_name">
                                ...
                                <option value="user"  @if($role->guard_name=='user') selected @endif>{{__('cms.user')}}</option>
                                <option value="user-api"  @if($role->guard_name=='user-api') selected @endif>{{__('cms.user_api')}}</option>
